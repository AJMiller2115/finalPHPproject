<?php
  require_once('connectvars.php');
		...
		$query = " SELECT * FROM products WHERE `productLine` = 'Trucks and Buses' ORDER BY productName LIMIT 10 OFFSET 10 ";
...
<body>
	...
	<h1>Truck and Bus Inventory</h1>
		<div id="page">
		<a href="truckinventory.php">Page 1</a>&nbsp&nbsp<a href="truckinventory2.php">Page 2</a>
	</div>
