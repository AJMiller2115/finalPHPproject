<?php
  require_once('connectvars.php');
		...
		$query = " SELECT * FROM products WHERE `productLine` = 'Planes' ORDER BY productName LIMIT 10 OFFSET 10 ";
...
<body>
	...
	<h1>Plane Inventory</h1>
		<div id="page">
		<a href="planeinventory.php">Page 1</a>&nbsp&nbsp<a href="planeinventory2.php">Page 2</a>
	</div>
